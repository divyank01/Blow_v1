...
public abstract class BlowFactory<T> {
	...
	protected abstract void kill(T t)throws Exception ;
	
	protected abstract T spawn()throws Exception ;
	
	protected abstract boolean validate(T t)throws Exception ;
	
	protected abstract void invalidateObject(T t) throws Exception ;
